...
const Registration = () => {
  ...
  return (
    <div className=" bg-gradient-to-tr from-blue-300 via-pink-300 to-cyan-300 h-screen top-0 z-0">
      <div className="w-1/4 m-auto bg-white rounded-md capitalize font-serif">
        <form
          ...
          <button
            type="submit"
            className="bg-red-300 py-1 mt-4 text-lg rounded-sm  hover:shadow-md hover:shadow-red-50">
            Submit
          </button>
        </form>
      </div>
